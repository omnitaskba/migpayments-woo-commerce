...
class MigpaymentsService
{
        ...
        )
    {
        try{
            ...
            $html .= '<div class="wc-migpayments-payment-item wc-migpayments-address"> <div class="wc-payment-data-item"> <label for="addresss">'.  $addressLbl  . '</label> <p> ' . $cryptoAddress . ' </p>  <button class="wc-migpayments-copy-btn" onclick="copyToClipboard(\''.  $cryptoAddress .'\')">Copy</button> </div></div> <div class="wc-migpayments-payment-item"> <div class="wc-payment-data-item" > <label for="total_crypto_amount">' . $amountLbl.'</label> <p id="total_crypto_amount" data-amount="'. $amount .'">  ' . $amount . ' ' . $currencyCode .' </p> </div> <button class="wc-migpayments-copy-btn"  onclick="copyToClipboard('. $amount. ')">Copy</button> </div>';
            $html .= '<div class="wc-migpayments-payment-item"> <div class="wc-payment-data-item"> <label for="network">Use this exact network:</label> <p> ' . strtoupper($blockchain) . ' </p> </div> </div>';
